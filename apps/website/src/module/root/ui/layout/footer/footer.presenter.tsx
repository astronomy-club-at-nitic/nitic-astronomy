...
export const Footer: FC<FooterProps> = ({ isSm, ...props }) => (
  <footer className="flex justify-center bg-dot-pattern p-6" {...props}>
      ...
      <div className="flex flex-col gap-2 border-b-2 border-slate-light-6 pb-2 sm:flex-row sm:gap-6">
        <div className="flex flex-col gap-2 border-b-2 border-slate-light-6 pb-2 sm:border-b-0 sm:border-r-2 sm:pr-6">
          <div className="flex gap-4">
            <Image src="/image/logo/dark.svg" sizes={64} alt="logo dark" className="h-16 w-16" />
            <Image src="/image/logo/light.svg" sizes={64} alt="logo light" className="h-16 w-16" />
          </div>
          <Image src="/image/logo/nitic.png" width={isSm ? 274 : 342} height={isSm ? 44 : 55} alt="logo nitic" />
        </div>
